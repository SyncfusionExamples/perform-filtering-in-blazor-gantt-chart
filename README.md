...
In this quick-start project, you can learn how to enable filtering, its hierarchy modes, operators, filter at initial rendering in the Syncfusion Gantt Chart in a Blazor WebAssembly application. You’ll also learn how to perform a filter on a particular column and clear all the filters in the Gantt Chart.
...
To run this application, you need to first clone or download the ‘perform filtering in blazor gantt chart’ repository and then open it in Visual Studio 2019. Now, build and run your project to view the output.
